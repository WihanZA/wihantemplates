---
title: "Guide to `dissertation`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Guide to `dissertation`}
...
You can find a complete example [here](https://github.com/WihanZA/wihantemplates/blob/master/examples/dissertation.pdf).
